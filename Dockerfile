#
# This dockerfile without buildin args: 
# +sv_lan 1 
# +map aim_map 
#
...
#CMD ./hlds_run -game cstrike -strictportbind -autoupdate -ip 0.0.0.0 -maxplayers 32
ENTRYPOINT ["./hlds_run", "-game cstrike -strictportbind -autoupdate -ip 0.0.0.0 -maxplayers 32 "]
